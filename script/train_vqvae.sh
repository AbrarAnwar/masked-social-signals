...
#SBATCH --time=4000
#SBATCH --output=/home/tangyimi/masked-social-signals/slurm_output/vqvae/30_%j.out
#SBATCH --job-name=vq30
...
python -m experiment.train --model=vqvae --sweep=vqvae_pose
