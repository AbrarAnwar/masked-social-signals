# # seed 42
python -m experiment.evaluate --module_path=./checkpoints/transformer/main/mask_speaker/masktransformertest_idx=27/epoch=149-val_loss=0.0027.ckpt --test_idx=27 --metric_dir=metrics/main --job=evaluate
